...
# v2.31 - Fixed fstab boot entries, keyfile permissions, visual tweaks
...
if [[ "$ENCRYPTION_MODE" == "password" ]]; then
    ...
    echo -e " ${C_GREEN}•${C_RESET} Don't be lazy, ${C_CYAN}remove USB${C_RESET} and store securely when not in use" >&2
