...
Securing a system always comes with trade-offs. This script aims to provide the user with a choice between the two most effective models for secure everyday use, depending on their threat scenario.
...
- Entire disk is essentially encrypted, except for the EFI/BIOS
...
Two choices are offered at the start:
