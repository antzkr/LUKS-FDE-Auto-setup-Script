...
Carefully assess whether the security of this setup works for you. FDE only works when the device is at rest: there is no protection while the device is powered on and running. See here for a deeper FDE assessment:
